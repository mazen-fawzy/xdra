    ...
    <div className="containerCo">
      <div className="sectionnnpt">
        ...
        <p>
          ...
          التي تقابلها و <Link href={""} className='redLink'>معايير البطولة</Link> معاد البطولة في تاريخ ٣/٢٤/٢٠٢٤ الساعة ٧ مساءا بتوقيت مصر على جميع الاعبين على جميع الاعبين
          على جميع الاعبين تسليم الاحتمال بالانترنت قبل معاد المسابقة ب عشرة دقائق على الاقل و الفرق المطابقة يتم اخالها من
          البطول
        </p>
        <button className="bookButton"><Link href={""}>احجز الان</Link></button>
      </div>
      <div className="sectionnnpt">
